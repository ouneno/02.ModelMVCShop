...
<!-- 회원가입, addUserView, /addUser.do 값 받기 -->
<html>
<head>
<title>회원가입</title>
						...
						<td>
							<table border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<!-- ID중복확인 -->
									<!--  중복확인 : fncCheckDuplication으로 자바스크립트 이동 -->
...
<!--  주민번호 / input type 포함 -->
	<tr>
		...
		<td class="ct_write01">
			...
			<!-- input typd에서 onChange로 최대 13자리 초과시 이벤트 발생 -->
...
<!-- form에 맞지 않을경우 onChange로 이벤트 발생 -->
			
			<!-- 1. option value : 선택박스 생성 첫번째 자리 고르기 -->
